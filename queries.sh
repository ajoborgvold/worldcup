...
FULL JOIN games AS winner_games ON teams.team_id = winner_games.winner_id 
FULL JOIN games AS opponent_games ON teams.team_id = opponent_games.opponent_id 
WHERE (winner_games.year=2014 AND winner_games.round='Eighth-Final') OR (opponent_games.year=2014 AND opponent_games.round='Eighth-Final')")"
